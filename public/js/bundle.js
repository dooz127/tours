...
var displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (location) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(location.coordinates).setHTML("<p>Day ".concat(location.day, ": ").concat(location.description)).addTo(map);
...
var stripe = Stripe('pk_test_jgyXYo6twj9ESMWRBB3xDf5Z');
...
var bookBtn = document.getElementById('book-tour'); // Delegate
